...
class EventsControllerTest < ActionDispatch::IntegrationTest
  I18n.available_locales.each do |locale|
    ...
    define_method("test_should_not_get_new_#{locale}") do
    ...
    define_method("test_should_not_get_update_#{locale}") do
      e = events(:one)
      patch event_url(e, params: {
        event: {
          name: "new name",
    ...
    define_method("test_should_not_get_destroy_#{locale}") do
      e = events(:one)
    ...
    define_method("test_should_not_get_destroy_with_wrong_token_#{locale}") do
      e = events(:one)
